    ...
    >
      <div className="mb-4 flex flex-wrap items-center gap-3">
        <div className="relative max-w-sm flex-1">
          ...
          <Input
            className="pl-9"
            placeholder="Search donor, email, reference, disaster..."
            value={search}
        ...
        <div className="rounded-md border border-border bg-card px-4 py-2 text-sm">
          ...
          <span className="font-display text-lg font-semibold text-relief tabular-nums">
            {formatPHP(total)}
          </span>
          ...
          <tbody className="divide-y divide-border">
            ...
            {filtered.map((d: any) => (
              <tr key={d.id} className="hover:bg-secondary/50">
                ...
                <td className="px-4 py-3 text-right font-semibold tabular-nums text-relief">
                  {formatPHP(d.amount)}
                </td>

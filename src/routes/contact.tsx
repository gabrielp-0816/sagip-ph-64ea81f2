...
export const Route = createFileRoute("/contact")({
  head: () => ({ meta: [{ title: "Contact — SAGIP" }, { name: "description", content: "Contact the City DRRM Office for disaster assistance, fund requests, or donations." }] }),
  component: () => (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 lg:px-8">
        ...
        <p className="mt-2 max-w-2xl text-muted-foreground">For emergencies, dial the city hotline. For platform questions, use the email below.</p>
...
function Card({ icon: Icon, label, value }: { icon: any; label: string; value: string }) {
  return (
    <div className="flex items-start gap-4 rounded-xl border border-border bg-card p-5">
      <div className="rounded-md bg-secondary p-2.5"><Icon className="h-4 w-4 text-primary" /></div>
      <div>

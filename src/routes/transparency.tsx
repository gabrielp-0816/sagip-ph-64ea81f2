  ...
  queryFn: async () => {
    const [d, a, r] = await Promise.all([
      ...
      supabase
        ...
        .select("label,allocated_amount,released_amount,disaster_categories(name)"),
...
export const Route = createFileRoute("/transparency")({
  head: () => ({
    meta: [
      { title: "Transparency — SAGIP" },
      {
        name: "description",
        content:
          "Public ledger of donations, allocations, and fund releases for the city disaster risk management fund.",
      },
    ],
  }),
        ...
        <section className="border-b border-border bg-paper py-12">
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            ...
            <p className="mt-2 max-w-2xl text-muted-foreground">
              Every donation, allocation, and release — published in real time.
            </p>
          </div>
        </section>

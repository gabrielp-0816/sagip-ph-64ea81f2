        ...
        <div className="mx-auto flex max-w-[1500px] items-center justify-between gap-3 px-4 py-3 lg:px-6">
          <div className="flex items-center gap-3">
            ...
            <Link to="/admin" className="flex items-center gap-3">
              ...
              <span
                className={cn(
                  "hidden rounded-full border px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.2em] sm:inline",
                  isSuperAdmin
                    ? "border-relief/50 bg-relief/15 text-relief"
      ...
      <div className="mx-auto flex max-w-[1500px] gap-6 px-4 py-6 lg:px-6">
        ...
        >
          ...
          <div className="mt-8 rounded-lg border border-white/10 bg-white/5 p-4 text-xs text-paper/70">
            ...
            <p className="mt-1">
              Ensure compliance and accuracy for all financial approvals. Use the highest scrutiny
